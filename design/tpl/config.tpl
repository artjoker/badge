    ...
    <div role="tabpanel" class="tab-pane active" id="home">
      <div class="row">
        <div class="col-md-6 col-sm-6">
          ...
          <div class="form-group">
            <label><?php echo $app->lang->get('Alarm emails') ?></label>
            <input type="text" name="alarm" value="<?php echo ALARM?>" class="form-control">
          </div>
          <div class="form-group">
            <label><?php echo $app->lang->get('Google API Key') ?></label>
